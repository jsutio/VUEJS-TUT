        ...
        <template v-slot:item.action="{ item }">
            <v-menu>
              <template v-slot:activator="{ props }">
                <v-btn v-bind="props" icon="mdi-dots-vertical" density="compact" class="ms-1" variant="plain" color="blue-darken-2" />
              </template>
              <v-list>
                <v-list-item>
                ...
                <v-list-item>
                  <v-btn size="small" prepend-icon="mdi-eye-settings-outline" variant="plain" color="blue-darken-2">View</v-btn>
                </v-list-item>
                <v-list-item>
        ...
        <template v-slot:tfoot>
          <tr>
            <td colspan="5">
              <v-switch
                    v-model="isActive"
                    :label="isActive ? 'showing active recorrds' : 'showing inactive records'"
                    color="red">
              </v-switch>
            </td>
          </tr>
